...
local Themes = {
	...
	Blue = {
		...
		AcrylicMain = Color3.fromRGB(15, 15, 25),
		AcrylicBorder = Color3.fromRGB(70, 90, 140),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 70, 130), Color3.fromRGB(20, 35, 60)),
		AcrylicNoise = 0.92,

		TitleBarLine = Color3.fromRGB(50, 75, 110),
		Tab = Color3.fromRGB(120, 140, 180),

		Element = Color3.fromRGB(100, 120, 160),
		ElementBorder = Color3.fromRGB(40, 50, 70),
		InElementBorder = Color3.fromRGB(70, 90, 110),
		ElementTransparency = 0.87,

		ToggleSlider = Color3.fromRGB(100, 120, 160),
		ToggleToggled = Color3.fromRGB(0, 0, 0),

		SliderRail = Color3.fromRGB(100, 120, 160),

		DropdownFrame = Color3.fromRGB(120, 150, 200),
		DropdownHolder = Color3.fromRGB(40, 45, 80),
		DropdownBorder = Color3.fromRGB(30, 40, 65),
		DropdownOption = Color3.fromRGB(100, 120, 160),

		Keybind = Color3.fromRGB(100, 120, 160),

		Input = Color3.fromRGB(100, 120, 160),
		InputFocused = Color3.fromRGB(15, 20, 30),
		InputIndicator = Color3.fromRGB(120, 150, 190),
		InputIndicatorFocus = Color3.fromRGB(40, 80, 170),

		Dialog = Color3.fromRGB(40, 45, 80),
		DialogHolder = Color3.fromRGB(35, 30, 65),
		DialogHolderLine = Color3.fromRGB(30, 25, 60),
		DialogButton = Color3.fromRGB(40, 45, 80),
		DialogButtonBorder = Color3.fromRGB(50, 80, 110),
		DialogBorder = Color3.fromRGB(50, 70, 100),
		DialogInput = Color3.fromRGB(50, 55, 85),
		DialogInputLine = Color3.fromRGB(125, 160, 190),

		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(100, 120, 160),
		HoverChange = 0.04,
	},
	...
	BrightBlue = {
		...
		AcrylicMain = Color3.fromRGB(25, 25, 40),
		AcrylicBorder = Color3.fromRGB(100, 130, 180),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(70, 100, 160), Color3.fromRGB(35, 50, 90)),
		AcrylicNoise = 0.92,

		TitleBarLine = Color3.fromRGB(70, 100, 150),
		Tab = Color3.fromRGB(150, 180, 220),

		Element = Color3.fromRGB(130, 160, 200),
		ElementBorder = Color3.fromRGB(60, 70, 100),
		InElementBorder = Color3.fromRGB(90, 110, 140),
		ElementTransparency = 0.8,

		ToggleSlider = Color3.fromRGB(130, 160, 200),
		ToggleToggled = Color3.fromRGB(10, 10, 20),

		SliderRail = Color3.fromRGB(130, 160, 200),

		DropdownFrame = Color3.fromRGB(160, 190, 240),
		DropdownHolder = Color3.fromRGB(60, 65, 100),
		DropdownBorder = Color3.fromRGB(50, 60, 90),
		DropdownOption = Color3.fromRGB(130, 160, 200),

		Keybind = Color3.fromRGB(130, 160, 200),

		Input = Color3.fromRGB(130, 160, 200),
		InputFocused = Color3.fromRGB(25, 30, 50),
		InputIndicator = Color3.fromRGB(160, 180, 230),
		InputIndicatorFocus = Color3.fromRGB(60, 120, 220),

		Dialog = Color3.fromRGB(60, 65, 100),
		DialogHolder = Color3.fromRGB(55, 50, 90),
		DialogHolderLine = Color3.fromRGB(50, 45, 80),
		DialogButton = Color3.fromRGB(60, 65, 100),
		DialogButtonBorder = Color3.fromRGB(80, 110, 150),
		DialogBorder = Color3.fromRGB(70, 90, 130),
		DialogInput = Color3.fromRGB(80, 90, 130),
		DialogInputLine = Color3.fromRGB(160, 190, 230),

		Text = Color3.fromRGB(250, 250, 250),
		SubText = Color3.fromRGB(200, 200, 200),
		Hover = Color3.fromRGB(130, 160, 200),
		HoverChange = 0.05,
	},

	EtherealSkylands = {
		Name = "EtherealSkylands",
		Accent = Color3.fromRGB(80, 180, 220),

		AcrylicMain = Color3.fromRGB(200, 220, 240),
		AcrylicBorder = Color3.fromRGB(150, 170, 200),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(120, 180, 220), Color3.fromRGB(60, 130, 180)),
		AcrylicNoise = 0.92,

		TitleBarLine = Color3.fromRGB(100, 140, 180),
		Tab = Color3.fromRGB(150, 180, 220),

		Element = Color3.fromRGB(130, 160, 200),
		ElementBorder = Color3.fromRGB(60, 90, 130),
		InElementBorder = Color3.fromRGB(100, 130, 170),
		ElementTransparency = 0.8,
		...
		DropdownFrame = Color3.fromRGB(180, 210, 240),
		DropdownHolder = Color3.fromRGB(70, 100, 140),
		...
		Input = Color3.fromRGB(130, 160, 200),
		InputFocused = Color3.fromRGB(25, 30, 50),
		InputIndicator = Color3.fromRGB(180, 220, 240),
		InputIndicatorFocus = Color3.fromRGB(80, 180, 220),

		Dialog = Color3.fromRGB(70, 100, 140),
		DialogHolder = Color3.fromRGB(60, 90, 130),
		DialogHolderLine = Color3.fromRGB(50, 80, 120),
		DialogButton = Color3.fromRGB(70, 100, 140),
		DialogButtonBorder = Color3.fromRGB(100, 130, 170),
		DialogBorder = Color3.fromRGB(90, 120, 160),
		DialogInput = Color3.fromRGB(100, 130, 160),
		DialogInputLine = Color3.fromRGB(180, 220, 240),
	...
	SkyBlue = {
		Name = "SkyBlue",
		Accent = Color3.fromRGB(85, 155, 225),

		AcrylicMain = Color3.fromRGB(135, 160, 210),
		AcrylicBorder = Color3.fromRGB(100, 140, 190),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(90, 140, 210), Color3.fromRGB(60, 90, 140)),
		AcrylicNoise = 0.92,

		TitleBarLine = Color3.fromRGB(90, 130, 190),
		Tab = Color3.fromRGB(160, 180, 220),

		Element = Color3.fromRGB(130, 160, 200),
		ElementBorder = Color3.fromRGB(70, 100, 140),
		InElementBorder = Color3.fromRGB(100, 130, 170),
		...
		DropdownFrame = Color3.fromRGB(160, 190, 240),
		DropdownHolder = Color3.fromRGB(80, 110, 150),
		DropdownBorder = Color3.fromRGB(70, 90, 130),
		DropdownOption = Color3.fromRGB(130, 160, 200),

		Keybind = Color3.fromRGB(130, 160, 200),

		Input = Color3.fromRGB(130, 160, 200),
		InputFocused = Color3.fromRGB(40, 60, 90),
		InputIndicator = Color3.fromRGB(160, 190, 240),
		InputIndicatorFocus = Color3.fromRGB(85, 155, 225),

		Dialog = Color3.fromRGB(80, 110, 150),
		DialogHolder = Color3.fromRGB(75, 100, 140),
		DialogHolderLine = Color3.fromRGB(70, 90, 130),
		DialogButton = Color3.fromRGB(80, 110, 150),
		DialogButtonBorder = Color3.fromRGB(100, 130, 170),
		DialogBorder = Color3.fromRGB(90, 120, 160),
		DialogInput = Color3.fromRGB(100, 130, 170),
		DialogInputLine = Color3.fromRGB(170, 200, 240),
	...
	DeepSkyBlue = {
		...
		AcrylicMain = Color3.fromRGB(95, 115, 160),
		AcrylicBorder = Color3.fromRGB(80, 110, 150),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(70, 100, 150), Color3.fromRGB(45, 60, 90)),
		AcrylicNoise = 0.92,

		TitleBarLine = Color3.fromRGB(70, 100, 150),
		Tab = Color3.fromRGB(130, 160, 200),

		Element = Color3.fromRGB(100, 130, 170),
		ElementBorder = Color3.fromRGB(60, 80, 110),
		InElementBorder = Color3.fromRGB(80, 110, 140),
		ElementTransparency = 0.9,

		ToggleSlider = Color3.fromRGB(100, 130, 170),
		ToggleToggled = Color3.fromRGB(0, 0, 0),

		SliderRail = Color3.fromRGB(100, 130, 170),

		DropdownFrame = Color3.fromRGB(140, 170, 210),
		DropdownHolder = Color3.fromRGB(70, 90, 130),
		DropdownBorder = Color3.fromRGB(60, 80, 110),
		DropdownOption = Color3.fromRGB(100, 130, 170),

		Keybind = Color3.fromRGB(100, 130, 170),

		Input = Color3.fromRGB(100, 130, 170),
		InputFocused = Color3.fromRGB(30, 45, 70),
		InputIndicator = Color3.fromRGB(140, 170, 210),
		InputIndicatorFocus = Color3.fromRGB(70, 130, 200),

		Dialog = Color3.fromRGB(70, 90, 130),
		DialogHolder = Color3.fromRGB(65, 85, 120),
		DialogHolderLine = Color3.fromRGB(55, 75, 110),
		DialogButton = Color3.fromRGB(70, 90, 130),
		DialogButtonBorder = Color3.fromRGB(80, 110, 150),
		DialogBorder = Color3.fromRGB(70, 100, 140),
		DialogInput = Color3.fromRGB(80, 110, 150),
		DialogInputLine = Color3.fromRGB(140, 170, 210),

		Text = Color3.fromRGB(230, 240, 250),
		SubText = Color3.fromRGB(180, 200, 220),
		Hover = Color3.fromRGB(100, 130, 170),
		HoverChange = 0.05,
	},
}
